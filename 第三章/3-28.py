...
text_UK = remove_tag(remove_link_markup(remove_markup(read_wiki_UK_text())))
...
国歌 : {{lang|en|God Save the Queen}}{{en icon}}神よ女王を護り賜え{{center|[[ファイル:United States Navy Band - God Save the Queen.ogg]]}}
地図画像 : Europe-UK.svg
