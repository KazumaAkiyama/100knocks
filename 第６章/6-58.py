...
#モデルもいっぱい用意する
lr_list = [LogisticRegression(C=parameter, max_iter=1000).fit(train_feature_nparr, train_category_nparr) for parameter in parameter_list]

#正解率計算のための関数　最初からこうしとけばよかった
